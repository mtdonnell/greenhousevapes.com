...
const CATALOG = [
  ...
  },
  {
    ...
    brands: [
      { name: "Water pipes", lines: "Beakers, straight tubes and percolators, in a range of sizes" },
      { name: "Hand pipes", lines: "Spoons, chillums and one-hitters" },
      { name: "Bubblers", lines: "Hand-held, water-cooled" },
      { name: "Dab rigs", lines: "Rigs and quartz" },
      { name: "Parts & extras", lines: "Bowls, downstems, ash catchers, screens and cleaner" },
    ],
  },
  {
    cat: "Accessories",
